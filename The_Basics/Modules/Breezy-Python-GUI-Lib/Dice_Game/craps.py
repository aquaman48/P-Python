...
class Player(object):
    ...
    def __str__(self):
        """Returns a string representation of the list of the last roll."""
        return self.roll
    ...
    def rollDice(self):
        ...
        #Game logic for one roll of dice
        if self.atStartup:
    ...
    """Note: both isWinner() and isLoser can be False, if the game is not finished"""
    ...
    def play(self):
        """Plays a game, counts the rolls for that game. Returns True or False if won or lost."""
