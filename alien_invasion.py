...
class AlienInvasion:
    ...
    def _update_bullets(self):
    	...
    	self.bullets.update()
    	#get rid of bullets once they go of screen
    ...
    def _update_aliens(self):
        """update position of fucking god damn aliens"""
    ...
    def _check_bullet_alien_collisions(self):
        ...
        #removes the bullet and aliens that collide
    ...
    def _create_fleet(self):
    	"""Creates my master fleet of destructive aliens that will rain down the hate"""
    	#makes an alien
    	alien = Alien(self)
